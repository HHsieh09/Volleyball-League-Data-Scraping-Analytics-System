...
'''Transform data into analytical format'''
'''Retrieve and transform Match data'''
def get_match():
    sql = f"""SELECT match_cup_id, 
            ...
            END AS CITY,
            CASE 
                WHEN arena = '臺灣體育大學體育館' THEN '台中市'
                WHEN arena = '臺灣大學綜合體育館' THEN '台北市'
                WHEN arena = '屏東縣立體育館' THEN '屏東縣'
                WHEN arena = '新竹縣體育館' THEN '新竹縣'
                WHEN arena = '臺北市立大學體育館' THEN '台北市'
                WHEN arena = '成功大學體育館' THEN '台南市'
                WHEN arena = '彰化師範大學體育館' THEN '彰化縣'
                WHEN arena = '輔仁大學中美堂' THEN '新北市'
                WHEN arena = '鳳山體育館' THEN '高雄市'
                WHEN arena = '新莊體育館' THEN '新北市'
                WHEN arena = '桃園體育館' THEN '桃園市'
                WHEN arena = '雲林縣立體育館' THEN '雲林縣'
                WHEN arena = '國北教大體育館' THEN '台北市'
                WHEN arena = '中原大學體育館' THEN '桃園市'
                WHEN arena = '嘉義市港坪體育館' THEN '嘉義市'
                WHEN arena = '苗栗巨蛋體育館' THEN '苗栗縣'
                WHEN arena = '雲科大體育館' THEN '雲林縣'
                WHEN arena = '彰化縣立體育館' THEN '彰化縣'
                WHEN arena = '花蓮小巨蛋體育館' THEN '花蓮縣'
                ELSE 'UNKNOWN'
            END AS CHI_CITY,
            duration,
            match_type,
...
'''Retrieve and transform Coach data'''
def get_coach():
    sql = f"""SELECT match_coach_id, 
            ...
            CASE
                ...
                WHEN team = '極速超跑' THEN 'Taoyuan City'
                ...
                WHEN team = '台電女排' THEN 'Kaohsiung City'
                ...
                WHEN team = '高雄台電' THEN 'Kaohsiung City'
            ...
            END AS TEAM_CITY,
            CASE
                WHEN team = '國訓中心' THEN '高雄市'
                WHEN team = '桃園石易' THEN '桃園市'
                WHEN team = '台電公司' THEN '屏東縣'
                WHEN team = 'MIZUNO' THEN '雲林縣'
                WHEN team = '長力男排' THEN '台中市'
                WHEN team = 'ATTACKLINE' THEN '台北市'
                WHEN team = '匯竑國際' THEN '新北市'
                WHEN team = '中國人纖' THEN '新北市'
                WHEN team = 'conti' THEN '台北市'
                WHEN team = '極速超跑' THEN '桃園市'
                WHEN team = '雲林Mizuno' THEN '雲林縣' 
                WHEN team = '桃園台灣產險' THEN '桃園市' 
                WHEN team = '愛山林' THEN '新北市'
                WHEN team = '臺北鯨華' THEN '台北市'
                WHEN team = '臺中長力' THEN '台中市'
                WHEN team = '桃園臺產' THEN '桃園市'
                WHEN team = '台電男排' THEN '屏東縣'
                WHEN team = '台電女排' THEN '高雄市'
                WHEN team = '桃園臺產隼鷹' THEN '桃園市'
                WHEN team = '屏東台電' THEN '屏東縣'
                WHEN team = '臺中太陽神' THEN '台中市'
                WHEN team = '愛山林建設' THEN '新北市'
                WHEN team = '高雄台電' THEN '高雄市'
                WHEN team = '桃園臺灣產險' THEN '桃園市'
                WHEN team = '連莊' THEN '台中市'
                WHEN team = '新北中纖' THEN '新北市'
                WHEN team = '臺北Conti' THEN '台北市'
                WHEN team = '連莊排球隊' THEN '台中市' 
                WHEN team = '彰化三大有線' THEN '彰化縣' 
                WHEN team = '雲林美津濃' THEN '雲林縣'
                WHEN team = '凱撒飯店連鎖' THEN '新北市'
                WHEN team = '義力營造' THEN '新北市'
            END AS CHI_TEAM_CITY,
            CASE
                WHEN team = '國訓中心' THEN 'Mens Division'
...
'''Retrieve and transform Match Score data'''
def get_score():
    sql = f"""SELECT score_id, 
            ...
            CASE
                ...
                WHEN match_team = '極速超跑' THEN 'Taoyuan City'
                ...
                WHEN match_team = '台電女排' THEN 'Kaohsiung City'
                ...
                WHEN match_team = '高雄台電' THEN 'Kaohsiung City'
            ...
            END AS TEAM_CITY,
            CASE
                WHEN match_team = '國訓中心' THEN '高雄市'
                WHEN match_team = '桃園石易' THEN '桃園市'
                WHEN match_team = '台電公司' THEN '屏東縣'
                WHEN match_team = 'MIZUNO' THEN '雲林縣'
                WHEN match_team = '長力男排' THEN '台中市'
                WHEN match_team = 'ATTACKLINE' THEN '台北市'
                WHEN match_team = '匯竑國際' THEN '新北市'
                WHEN match_team = '中國人纖' THEN '新北市'
                WHEN match_team = 'conti' THEN '台北市'
                WHEN match_team = '極速超跑' THEN '桃園市'
                WHEN match_team = '雲林Mizuno' THEN '雲林縣' 
                WHEN match_team = '桃園台灣產險' THEN '桃園市' 
                WHEN match_team = '愛山林' THEN '新北市'
                WHEN match_team = '臺北鯨華' THEN '台北市'
                WHEN match_team = '臺中長力' THEN '台中市'
                WHEN match_team = '桃園臺產' THEN '桃園市'
                WHEN match_team = '台電男排' THEN '屏東縣'
                WHEN match_team = '台電女排' THEN '高雄市'
                WHEN match_team = '桃園臺產隼鷹' THEN '桃園市'
                WHEN match_team = '屏東台電' THEN '屏東縣'
                WHEN match_team = '臺中太陽神' THEN '台中市'
                WHEN match_team = '愛山林建設' THEN '新北市'
                WHEN match_team = '高雄台電' THEN '高雄市'
                WHEN match_team = '桃園臺灣產險' THEN '桃園市'
                WHEN match_team = '連莊' THEN '台中市'
                WHEN match_team = '新北中纖' THEN '新北市'
                WHEN match_team = '臺北Conti' THEN '台北市'
                WHEN match_team = '連莊排球隊' THEN '台中市' 
                WHEN match_team = '彰化三大有線' THEN '彰化縣' 
                WHEN match_team = '雲林美津濃' THEN '雲林縣'
                WHEN match_team = '凱撒飯店連鎖' THEN '新北市'
                WHEN match_team = '義力營造' THEN '新北市'
            END AS CHI_TEAM_CITY,
            CASE
                WHEN match_team = '國訓中心' THEN 'Mens Division'
                WHEN match_team = '桃園石易' THEN 'Mens Division'
                WHEN match_team = '台電公司' THEN 'Mens Division'
                WHEN match_team = 'MIZUNO' THEN 'Mens Division'
                WHEN match_team = '長力男排' THEN 'Mens Division'
                WHEN match_team = 'ATTACKLINE' THEN 'Womens Division'
                WHEN match_team = '匯竑國際' THEN 'Womens Division'
                WHEN match_team = '中國人纖' THEN 'Womens Division'
                WHEN match_team = 'conti' THEN 'Mens Division'
                WHEN match_team = '極速超跑' THEN 'Womens Division'
                WHEN match_team = '雲林Mizuno' THEN 'Mens Division'
                WHEN match_team = '桃園台灣產險' THEN 'Mens Division'
                WHEN match_team = '愛山林' THEN 'Womens Division'
                WHEN match_team = '臺北鯨華' THEN 'Womens Division'
                WHEN match_team = '臺中長力' THEN 'Mens Division'
                WHEN match_team = '桃園臺產' THEN 'Mens Division'
                WHEN match_team = '台電男排' THEN 'Mens Division'
                WHEN match_team = '台電女排' THEN 'Womens Division'
                WHEN match_team = '桃園臺產隼鷹' THEN 'Mens Division'
                WHEN match_team = '屏東台電' THEN 'Mens Division'
                WHEN match_team = '臺中太陽神' THEN 'Mens Division'
                WHEN match_team = '愛山林建設' THEN 'Womens Division'
                WHEN match_team = '高雄台電' THEN 'Womens Division'
                WHEN match_team = '桃園臺灣產險' THEN 'Mens Division'
                WHEN match_team = '連莊' THEN 'Mens Division'
                WHEN match_team = '新北中纖' THEN 'Womens Division'
                WHEN match_team = '臺北Conti' THEN 'Mens Division'
                WHEN match_team = '連莊排球隊' THEN 'Mens Division'
                WHEN match_team = '彰化三大有線' THEN 'Mens Division' 
                WHEN match_team = '雲林美津濃' THEN 'Mens Division'
                WHEN match_team = '凱撒飯店連鎖' THEN 'Womens Division'
                WHEN match_team = '義力營造' THEN 'Womens Division'
            END AS DIVISION,
            set1,
            set2,
            set3,
...
'''Retrieve and transform Player Stats data'''
...
'''Retrieve and transform Match Referee data'''
def get_referee():
