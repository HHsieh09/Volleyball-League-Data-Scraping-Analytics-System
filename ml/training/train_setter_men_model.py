...
setter_men = setter_data[setter_data["DIVISION"]=="Mens Division"]
print(setter_men)

setter_men = setter_men[["set_percentage","dig_percentage","receive_percentage","total_point_score","national_team"]].fillna(0)

X = setter_men[["set_percentage","dig_percentage","receive_percentage","total_point_score"]]
y = setter_men[["national_team"]]
