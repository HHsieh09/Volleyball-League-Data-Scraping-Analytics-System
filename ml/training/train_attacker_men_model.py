...
attacker_men = attacker_data[attacker_data["DIVISION"]=="Mens Division"]
print(attacker_men)

attacker_men = attacker_men[["attack_percentage", "block_total", "serve_percentage", "total_point_score","receive_percentage","dig_percentage","set_percentage","national_team"]].fillna(0)

X = attacker_men[["attack_percentage", "block_total", "serve_percentage", "total_point_score","receive_percentage","dig_percentage","set_percentage"]]
y = attacker_men["national_team"]
...
joblib.dump(attacker_model, "ml/attacker_model_men.pkl")